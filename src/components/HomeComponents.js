...
export const HomeSections = ({ onSelectCategory, onSelectPost, categories, articles }) => {
    ...
    return (
        <View style={{ backgroundColor: 'transparent' }}>
            {/* Categorías */}
            <View style={{ backgroundColor: 'white', marginHorizontal: 4, borderRadius: 28, borderWidth: 1, borderColor: '#F8FAFC', shadowColor: '#94A3B8', shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.15, shadowRadius: 15, elevation: 6, paddingHorizontal: 20, paddingVertical: 24 }}>
                ...
                <View style={styles.categoriesGrid}>
                    {displayCategories.slice(0, 9).map(cat => (
                        ...
                        >
                            <View style={[styles.catIconCircle, { backgroundColor: cat.color || '#F1F5F9', marginBottom: 8, shadowColor: cat.iconColor || '#EA580C', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.2, shadowRadius: 8, elevation: 3 }]}>
            ...
            {/* Cómo funciona */}
            <View style={[styles.howToCard, { marginBottom: 0, marginHorizontal: 4, borderRadius: 28, borderWidth: 1, borderColor: '#F8FAFC', shadowColor: '#94A3B8', shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.15, shadowRadius: 15, elevation: 6 }]}>
                ...
                <View style={styles.stepsRow}>
                    <View style={styles.step}>
                        <View style={[styles.stepBadge, { backgroundColor: '#FFEDD5', shadowColor: '#EA580C', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.2, shadowRadius: 6, elevation: 3 }]}><Text style={[styles.stepNumber, { color: '#EA580C' }]}>1</Text></View>
                        <Text style={styles.stepLabel}>Pide</Text>
                    </View>
                    <View style={styles.step}>
                        <View style={[styles.stepBadge, { backgroundColor: '#DBEAFE', shadowColor: '#2563EB', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.2, shadowRadius: 6, elevation: 3 }]}><Text style={[styles.stepNumber, { color: '#2563EB' }]}>2</Text></View>
                        <Text style={styles.stepLabel}>Recibe</Text>
                    </View>
                    <View style={styles.step}>
                        <View style={[styles.stepBadge, { backgroundColor: '#DCFCE7', shadowColor: '#16A34A', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.2, shadowRadius: 6, elevation: 3 }]}><Text style={[styles.stepNumber, { color: '#16A34A' }]}>3</Text></View>
