...
const RatingForm = ({ onSubmit, revieweeName, isForPro, onCancel, isBlocked }) => {
    ...
    return (
        <View style={{ backgroundColor: '#F8FAFC', borderRadius: 20, padding: 20, borderWidth: 1, borderColor: '#E2E8F0', marginTop: 10 }}>
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'center', marginBottom: isBlocked ? 0 : 20 }}>
                {[1, 2, 3, 4, 5].map(s => (
                    <TouchableOpacity key={s} onPress={() => setRating(s)} disabled={isBlocked}>
