    ...
    return (
        <View style={styles.heroCard}>
            <View style={styles.heroHeader}>
                ...
                <Text style={styles.heroSubtitle}>Describe tu problema y recibe ofertas.</Text>
            </View>
            ...
            <View style={styles.formContainer}>
                ...
                <TouchableOpacity style={styles.searchButton} onPress={handleSend}>
                    <Text style={styles.searchButtonText}>Solicitar Oferta</Text>
...
const styles = StyleSheet.create({
    heroCard: { backgroundColor: 'white', borderRadius: 20, overflow: 'hidden', marginBottom: 12, shadowColor: "#000", shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.1, shadowRadius: 4, elevation: 3 },
    ...
    formContainer: { padding: 20, paddingBottom: 10 },
    ...
    searchButton: { backgroundColor: '#111827', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', paddingVertical: 14, borderRadius: 14, marginTop: 10 },
