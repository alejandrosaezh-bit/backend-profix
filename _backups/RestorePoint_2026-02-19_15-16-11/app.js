                ...
                {isLoggedIn ? (
                    <TouchableOpacity
                        ...
                        style={{
                            ...
                            paddingVertical: 8,
                            borderRadius: 20,
                            backgroundColor: userMode === 'client' ? '#EFF6FF' : '#FFF7ED',
                            borderWidth: 1,
                            borderColor: userMode === 'client' ? '#2563EB' : '#EA580C',
                            elevation: 1,
                            shadowColor: '#000',
                            shadowOffset: { width: 0, height: 1 },
                            shadowOpacity: 0.05,
                    ...
                    >
                        <MaterialCommunityIcons
                            name={userMode === 'client' ? "account" : "briefcase"}
                            size={16}
                        ...
                        <Text style={{
                            fontSize: 13,
                            fontWeight: '700',
                            color: userMode === 'client' ? '#1E40AF' : '#9A3412',
                        }}>
                            {userMode === 'client' ? 'Soy Cliente' : 'Soy Profesional'}
                        </Text>
