            ...
            <View style={{ alignItems: 'center', marginTop: 10, width: '100%' }}>
              ...
              <View style={{
                ...
                <View style={{ flexDirection: 'row', marginRight: 8 }}>
                  <View style={[styles.miniAvatar, { zIndex: 3, backgroundColor: '#BFDBFE' }]}><Text style={{ fontSize: 10, color: '#1E40AF' }}>JP</Text></View>
                  <View style={[styles.miniAvatar, { zIndex: 2, marginLeft: -10, backgroundColor: '#BBF7D0' }]}><Text style={{ fontSize: 10, color: '#166534' }}>AN</Text></View>
                  <View style={[styles.miniAvatar, { zIndex: 1, marginLeft: -10, backgroundColor: '#FECACA' }]}><Text style={{ fontSize: 10, color: '#991B1B' }}>MR</Text></View>
                </View>
                <Text style={{ color: '#1E40AF', fontSize: 12, fontWeight: '600' }}>
                  +47,489 profesionales listos para ayudarte
                </Text>
              </View>
