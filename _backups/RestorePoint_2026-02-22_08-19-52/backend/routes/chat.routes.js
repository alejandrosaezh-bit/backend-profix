...
router.get('/', protect, async (req, res) => {
    try {
        let chats = await Chat.find({ participants: req.user._id })
            ...
            .select('_id job participants lastMessage lastMessageDate messages._id messages.read messages.sender messages.content messages.media messages.mediaType messages.createdAt')
