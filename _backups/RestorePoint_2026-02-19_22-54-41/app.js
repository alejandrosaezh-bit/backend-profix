                ...
                {isLoggedIn ? (
                    ...
                    >
                        <Text style={{
                            ...
                            {userMode === 'client' ? 'Profesional' : 'Cliente'}
                        </Text>

                        {/* Custom Two-Color Circular Arrows */}
                        <View style={{ width: 18, height: 18, justifyContent: 'center', alignItems: 'center' }}>
                            <MaterialCommunityIcons
                                name="arrow-top-right-thick"
                                size={12}
                                color="#EA580C"
                                style={{ position: 'absolute', top: -2, right: -2, transform: [{ rotate: '15deg' }] }}
                            />
                            <MaterialCommunityIcons
                                name="arrow-bottom-left-thick"
                                size={12}
                                color="#2563EB"
                                style={{ position: 'absolute', bottom: -2, left: -2, transform: [{ rotate: '15deg' }] }}
                            />
                        </View>
                    </TouchableOpacity>
                ) : (
                        ...
                        >
                            {availableJobsForPro.length === 0 ? (
                                activeCategories.length === 0 ? (
                                    <View style={{ marginTop: 20, padding: 25, backgroundColor: '#FFFFFF', borderRadius: 20, borderWidth: 1, borderColor: '#BFDBFE', alignItems: 'center', shadowColor: '#2563EB', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.1, shadowRadius: 10, elevation: 5 }}>
                                        <Image
                                    ...
                                    <View style={{ alignItems: 'center', marginTop: 40, padding: 25, backgroundColor: '#F8FAFC', borderRadius: 20, borderStyle: 'dashed', borderWidth: 2, borderColor: '#CBD5E1' }}>
...
const styles = StyleSheet.create({
    ...
    header: {
        ...
        paddingHorizontal: 10, // Adjusted to reduce space on the left
